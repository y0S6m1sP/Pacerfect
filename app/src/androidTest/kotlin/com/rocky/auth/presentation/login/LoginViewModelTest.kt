...
import com.rocky.auth.data.LoginRequest
import com.rocky.auth.domain.UserDataValidator
import com.rocky.core.android_test.SessionStorageFake
import com.rocky.core.android_test.TestMockEngine
import com.rocky.core.android_test.loginResponseStub
...
class LoginViewModelTest {
    ...
    fun testLogin() = runTest {
        ...
        assertThat(viewModel.state.email.text.toString()).isEqualTo("test@gmail.com")
        ...
        assertThat(loginBody.email).isEqualTo("test@gmail.com")
