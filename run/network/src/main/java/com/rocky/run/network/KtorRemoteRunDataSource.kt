...
import com.rocky.core.data.networking.constructRoute
import com.rocky.core.data.networking.delete
import com.rocky.core.data.networking.get
import com.rocky.core.data.networking.safeCall
...
import com.rocky.core.domain.util.map
...
class KtorRemoteRunDataSource(
    ...
    override suspend fun postRun(run: Run, mapPicture: ByteArray): Result<Run, DataError.Network> {
            ...
            httpClient.submitFormWithBinaryData(
                ...
                formData = formData {
                    append("MAP_PICTURE", mapPicture, Headers.build {
                        ...
                        append(HttpHeaders.ContentDisposition, "filename=map.jpg")
                    })
        ...
        return result.map { runDto -> runDto.toRun() }
    }
